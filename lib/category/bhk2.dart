...
class BHKtwo extends StatefulWidget {
  const BHKtwo({super.key});

  @override
  State<BHKtwo> createState() => _BHKtwoState();
}

int ink = 3;

class _BHKtwoState extends State<BHKtwo> {
  @override
  @override
  void initState() {
    house();
